...
class LogOutputPanel(tk.Frame):
    def __init__(self, parent, app_protocol):
        ...
        # Label at the top
        self.label = tk.Label(self, text="Logs:", bg=DARK_BG, fg=TEXT_COLOR, font=HEADER_FONT)
        ...
        self.log = scrolledtext.ScrolledText(self, bg=DARKER_BG, fg=TEXT_COLOR, font=FONT)
